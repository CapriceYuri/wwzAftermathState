...
export default function HordeLordCard() {
  return (
    <Card
      className="w-[100%] mx-auto mb-4 bg-transparent rounded-2xl backdrop-blur-xl shadow-[0_0_40px_indigo] relative"
      shadow={false}
    >
      <div className="bg-gradient-to-t from-indigo-400 to-indigo-600 h-full w-full object-cover rounded-2xl fixed -z-10 opacity-60" />
      <List className="z-20 relative">
        <div
          className={`bg-[url(/rings/hordebg.gif)] border-2 border-black rounded-2xl bg-contain opacity-80 absolute h-full w-full top-0 left-0 -z-10 `}
        />
        <div>
          <Typography
            color="white"
